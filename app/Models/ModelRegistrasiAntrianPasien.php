...
class ModelRegistrasiAntrianPasien extends Model
{
    ...
    protected $allowedFields = [
        'no_reg', 'no_rawat ', 'tgl_registrasi', 'jam_reg', 'kd_dokter', 'no_rkm_medis', 'kd_poli', 'almt_pj', 'hubunganpj', 'biaya_reg', 'stts', 'stts_daftar', 'status_lanjut', 'kd_pj', 'umurdaftar', 'sttsumur', 'status_bayar'
    ];
