        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="position-relative rounded overflow-hidden h-100" style="min-height: 400px">
                    <img class="position-absolute w-100 h-100" src="<?= base_url(); ?>/assets/img/feature.jpg" alt=""
                        style="object-fit: cover" />
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-3 d-none d-lg-block">
                <div class="testimonial-left h-100">
                    <img class="img-fluid animated pulse infinite" src="<?= base_url(); ?>/assets/img/testimonial-1.jpg"
                        alt="" />
                    <img class="img-fluid animated pulse infinite" src="<?= base_url(); ?>/assets/img/testimonial-2.jpg"
                        alt="" />
                    <img class="img-fluid animated pulse infinite" src="<?= base_url(); ?>/assets/img/testimonial-3.jpg"
                        alt="" />
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
