            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12">
                        <div class="hero-text">
                            <div class="hero-title-wrap d-flex align-items-center mb-4">
                                <img src="<?= base_url(); ?>/assets/images/happy-bearded-young-man.jpg"
                    ...
                    <div class="col-lg-5 col-12 position-relative">
                        ...
                        <img src="<?= base_url(); ?>/assets/images/portrait-happy-excited-man-holding-laptop-computer.png"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <img src="<?= base_url(); ?>/assets/images/couple-working-from-home-together-sofa.jpg"
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-2 col-4 ms-auto clients-item-height">
                        <img src="<?= base_url(); ?>/assets/images/clients/cachet.svg" class="clients-image img-fluid"
                            alt="">
                    </div>

                    <div class="col-lg-2 col-4 clients-item-height">
                        <img src="<?= base_url(); ?>/assets/images/clients/guitar-center.svg"
                            class="clients-image img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-4 clients-item-height">
                        <img src="<?= base_url(); ?>/assets/images/clients/tokico.svg" class="clients-image img-fluid"
                            alt="">
                    </div>

                    <div class="col-lg-2 col-4 clients-item-height">
                        <img src="<?= base_url(); ?>/assets/images/clients/shopify.svg" class="clients-image img-fluid"
                            alt="">
                    </div>

                    <div class="col-lg-2 col-4 me-auto clients-item-height">
                        <img src="<?= base_url(); ?>/assets/images/clients/profil-rejser.svg"
                            class="clients-image img-fluid" alt="">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 mx-auto">
                        <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                            <img src="<?= base_url(); ?>/assets/images/handshake-man-woman-after-signing-business-contract-closeup.jpg"
                                class="avatar-image img-fluid" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-12 ms-auto">
                        <div class="section-title-wrap d-flex justify-content-center align-items-center mb-4">
                            <img src="<?= base_url(); ?>/assets/images/white-desk-work-study-aesthetics.jpg"
                                class="avatar-image img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="projects-thumb">
                            ...
                            <a href="images/projects/nikhil-KO4io-eCAXA-unsplash.jpg" class="popup-image">
                                <img src="<?= base_url(); ?>/assets/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="projects-thumb">
                            ...
                            <a href="images/projects/the-5th-IQYR7N67dhM-unsplash.jpg" class="popup-image">
                                <img src="<?= base_url(); ?>/assets/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg"
                                    class="projects-image img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="projects-thumb">
                            ...
                            <a href="images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" class="popup-image">
                                <img src="<?= base_url(); ?>/assets/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg"
                                    class="projects-image img-fluid" alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-12">
                        <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                            <img src="<?= base_url(); ?>/assets/images/aerial-view-man-using-computer-laptop-wooden-table.jpg"
                                class="avatar-image img-fluid" alt="">
